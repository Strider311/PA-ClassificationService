...
class NumpyClassifier():
    def __init__(self, min: float, max: float) -> None:
        self.min = min
        self.max = max
        self.root_dir = os.getenv("BASE_DIR")
    ...
    def apply_filter(self, file_name: str):
        ...
        final_image = healthy + final + soil
    ...
    def __find_soil__(self, img):
        color = (53, 53, 100)
        processed_img = self.__get_countours__(img, 0, 0.3, color)
    ...
    def __apply_cv2_contours__(self, img, min, max, color: list):
